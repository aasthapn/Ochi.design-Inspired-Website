import { a, h5 } from 'framer-motion/client'
...
const Footer = () => {
    ...
    return (
        <div className='w-full h-screen flex  text-["Neue Montreal"]'>
            <div className='w-1/2 h-full flex flex-col justify-between p-20'>
                <div className='heading'>
                    <h1 className='text-[6vw] font-semibold uppercase -mb-4 tracking-tighter leading-none'>eye-</h1>
                    <h1 className='text-[6vw] font-semibold uppercase -mb-4 tracking-tighter leading-none'> opening</h1>
                    </div>
             ...
             <h1 className='text-[6vw] font-semibold uppercase -mb-6 tracking-tighter leading-none'>presentations</h1>
             <div className='flex items-center gap-20 justify-between'>
             <div className='w-1/2 h-full '>
                <h3 className='mt-12'>S:</h3>
                {["Instagram","Behance","Facebook","Linkedin"].map((index,item) =>{
                    return(
                <h5> <a className='underline ' href="#">{index}</a> <br/> </h5>  
         ...
         <h3 className='mt-12'>M:</h3>
                {nav.map((item,index) =>
                    ...
                    to={item.path}
                    key={index}
                  className={`text-1xl underline <br/> `}
                  onClick={() => {
                    if (item.path === '/') {
                      window.scrollTo(0, 0); 
                    }
